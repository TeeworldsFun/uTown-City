...
MACRO_CONFIG_INT(SvMaxDummys, sv_max_dummys, 64, 1, 64, CFGFLAG_SERVER|CFGFLAG_SAVE, "Maximum number of Dummys that are allowed on a server");
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 32, 1, 32, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
